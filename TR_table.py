...
# ────────────────────────────────────────────────────────────────────
SEG_CFG = {
    "epilepsy": dict(num_segments=10, min_seg_len=10, max_seg_len=10),
    "freezer":  dict(num_segments=5,  min_seg_len=10, max_seg_len=100),
    "boiler":   dict(num_segments=50, min_seg_len=1,  max_seg_len=36),
    "wafer":    dict(num_segments=5,  min_seg_len=10, max_seg_len=152),
    "PAM":      dict(num_segments=10, min_seg_len=10, max_seg_len=600),
}
...
def npy_path(results_dir, data, kind, fold, cfg, model_type, seed):
    key = f"timing_td_{kind}_{seg_key(cfg)}"
